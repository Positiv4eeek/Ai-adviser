export default {
  ...
  dashboard: {
    ...
    ai_recommendations: "AI ұсыныстары",
    selectPrompt: "Промптты таңдаңыз",
    getRecommendations: "Ұсынымдарды алу",
    ai_history: "ЖИ ұсыныстарының тарихы",
    no_history: "Әзірге ешқандай ұсыныс жоқ",
    prompt_name: "Промпт атауы",
