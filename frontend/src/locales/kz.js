export default {
  ...
  register: {
    ...
    submit: "Тіркелу",
    loading: "Жүктелуде...",
    success: "Тіркеу сәтті өтті! Кіру бетіне бағытталуда…",
    error: "Тіркелу сәтсіз аяқталды",
    verificationSent: "Растау коды поштаңызға жіберілді. Тексеріңіз.",
    invalid_domain: "Тіркеу тек narxoz.kz пошта арқылы ғана мүмкін",
    email_exists: "Бұл электрондық пошта бұрын тіркелген"
  },
  home: {
